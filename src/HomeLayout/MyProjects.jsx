import { FaReact, FaExternalLinkAlt, FaGithub, FaAppStore } from "react-icons/fa";
...
const projects = [
    ...
    },
    {
        ...
        image:
            "https://i.ibb.co.com/VcHckbff/Screenshot-2025-12-28-at-5-59-58-PM.png",
        tech: ["React", "API", "UI", "Node.js", "Cors", "JavaScrip", "CSS"],
    },
    {
        id: 3,
        title: "Apps 4 U",
        ...
        description:
            "A website thats includes your application, user can install and uninstall it with UI/UX and responsive design.",
        image:
            "https://i.ibb.co.com/wrRpbgdG/Screenshot-2025-12-28-at-6-04-13-PM.png",
...
const MyProjects = () => {
    return (
        <section id="project-section" className="py-6 pb-20 relative">
    ...
    text-transparent bg-clip-text bg-linear-to-r from-emerald-600 to-lime-500
      border-2 border-gradient-to-r border-lime-500 px-3 py-1"
                                        ...
                                        <div className="card-actions mt-4">
                                            <button className="btn px-8 text-white 
